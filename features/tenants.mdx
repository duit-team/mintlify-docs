...
<Warning>
  Need to clear a location's sales history, fully reset a tenant, or duplicate one as a template? Those are destructive, hard-to-reverse actions handled on a separate page: see [Tenant Operations](/features/tenant-operations). They are not available from the regular tenant edit screen.
</Warning>
...
<CardGroup cols={2}>
  <Card title="Tenant Operations" icon="triangle-alert" href="/features/tenant-operations">Clear sales, wipe, or clone a tenant</Card>
